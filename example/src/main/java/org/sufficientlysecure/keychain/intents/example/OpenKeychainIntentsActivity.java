...
package org.sufficientlysecure.keychain.intents.example;
...
public class OpenKeychainIntentsActivity extends PreferenceActivity {
        ...
        mEncrypt.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                try {
                    ...
                    Toast.makeText(OpenKeychainIntentsActivity.this, "Activity not found!", Toast.LENGTH_LONG).show();
                }
